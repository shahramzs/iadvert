...
React.useEffect(() => {
  const SERVER_URL = "http://127.0.0.1:8000";
  const url = `${SERVER_URL}/src/api/save.php`;
...
const deleteSave = (token) => {
  ...
  console.log(`
            ...
            axios({
                method: 'POST',
                url : `${SERVER_URL}/src/api/deleteSave.php`,
                data : formData,
                responseType: 'json',
                config : {headers : { 'Content-Type': 'multipart/form-data' }}
            })
...
React.useEffect(() => {
  document.title  = `${sessionStorage.getItem('user')} / Advert Saved`;
  return () => {
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
            ...
            <ListItem button onClick={save} style={{background:'silver'}}>
                <ListItemIcon>
                     <SaveAltIcon />
                </ListItemIcon>
              ...
              <Grid item xs={4} >
                <Card className={classes.root1}>
                    ...
                    <CardContent>
                      ...
                      <Typography variant="body2" color="textSecondary" component="p">
                        Number of Pictures:{info.numPic ? info.numPic : 0} 
                      </Typography>
                      <Typography variant="body2" color="textSecondary" component="p">
                        User name:{info.user} 
                      </Typography>
                    ...
                    <CardActions disableSpacing>
                      <IconButton aria-label="add to favorites" onClick={()=> deleteSave(info.token)}>
                        <DeleteIcon />
                      </IconButton>
