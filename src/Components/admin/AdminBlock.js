...
React.useEffect(() => {
  ...
  const url = `${SERVER_URL}/src/api/admin/adminBlock.php`;
...
const unblock = async (id) => {
 ...
 setAdvert(newId);
  ...
  await axios({
    method: 'POST',
    url : `${SERVER_URL}/src/api/admin/unblock.php`,
    data : formData,
    responseType: 'json',
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
            ...
            <ListItem button onClick={block} style={{background:'silver'}}>
                <ListItemIcon>
                     <BlockIcon/>
                </ListItemIcon>
      ...
      <main className={classes.content}>
        ...
        {advert && advert.length === 0 || advert === 'noAdvert' ? <Alert severity="error" style={{width:'50%',margin:'0 auto'}}>
                                                                <AlertTitle>No User Blocked.</AlertTitle>
                                                                You Don't Have Any Blocked User  Yet. 
                                                              </Alert> : 
        <React.Fragment>
              ...
              <Grid item xs={12} key={i}>
                <Card className={classes.root} variant="outlined">
                  <CardContent>
                    ...
                    <CardActions>
                    <Button variant="outlined" color="secondary" size="small" onClick={()=>unblock(info.id)}>unBlock</Button>
                  </CardActions>
                  </CardContent>
                </Card>
              </Grid>
...
export default withRouter(AdminBlock)