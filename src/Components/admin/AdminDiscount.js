...
React.useEffect(() => {
  ...
  const url = `${SERVER_URL}/src/api/admin/discountSaveAdmin.php`;
...
const deleteSave = (code) => {
  ...
  console.log(`
            ...
            axios({
                method: 'POST',
                url : `${SERVER_URL}/src/api/admin/deleteDiscountSave.php`,
                data : formData,
                responseType: 'json',
...
export default withRouter(AdminDiscount)